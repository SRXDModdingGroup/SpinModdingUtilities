...
public static class FieldAccessor<T, U>
{
    ...
    // field name -> accessor
    private static readonly SingleCreationValueCache<string, Accessor> accessors = new();
...
public static class PropertyAccessor<T, U>
{
    ...
    private static readonly SingleCreationValueCache<string, (Getter get, Setter set)> props = new();
...
public static class MethodAccessor<T, TDelegate> where TDelegate : Delegate
{
    ...
    private static readonly SingleCreationValueCache<string, TDelegate> methods = new();
